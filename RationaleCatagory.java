...
public class RationaleCatagory extends AppCompatActivity {
    protected DataHolder globalHolder;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rationale_catagory);
...
try {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_rationale_catagory, menu);
        return true;
    }
